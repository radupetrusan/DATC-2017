...
namespace AlbumPhoto.Service
{
	public class AlbumFotoService
	{
        ...
        private BlobContainerPermissions blobContainerPermissions;
        ...
        public AlbumFotoService()
		{
            ...
            blobContainerPermissions.SharedAccessPolicies.Add("twohourspolicy", new SharedAccessBlobPolicy()
            {
            ...
            _photoContainer.SetPermissions(blobContainerPermissions);
            signature = _photoContainer.GetSharedAccessSignature(new SharedAccessBlobPolicy(), "twohourspolicy");
        ...
        public static string GetSasBlobUrl(string fileName)
        {
            ...
            CloudBlobClient sasBlobClient = new CloudBlobClient(storageAccount.BlobEndpoint, new StorageCredentials(signature));
