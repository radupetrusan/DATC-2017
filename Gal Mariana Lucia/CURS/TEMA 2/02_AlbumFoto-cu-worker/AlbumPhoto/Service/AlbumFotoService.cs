...
namespace AlbumPhoto.Service
{
	public class AlbumFotoService
	{
        ...
        public AlbumFotoService()
		{
            ...
            accessSignature = _photoContainer.GetSharedAccessSignature(new SharedAccessBlobPolicy(), "twohourspolicy");
        ...
        public static string GetSasBlobUrl(string fileName)
        {
            ...
            CloudBlobClient sasBlobClient = new CloudBlobClient(storageAccount.BlobEndpoint, new StorageCredentials(accessSignature));
            CloudBlob blob = (CloudBlob)sasBlobClient.GetBlobReferenceFromServer(new Uri(fileName));
            return blob.Uri.AbsoluteUri + accessSignature;
        }
